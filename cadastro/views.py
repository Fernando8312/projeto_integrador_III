...
from configuracoes.models import Profissionais, Empresa
...
def termo(request, id):
    ...
    dados = {
        ...
        'email': usuario.email,
        'animais': Animais.objects.filter(usuario=usuario.id),
        'veterinario': Profissionais.objects.all(),
        'empresa': empresa,
        'end_empresa': empresa.endereco,
        'tel1_empresa':empresa.telefone1,
        'tel2_empresa':empresa.telefone2,
        }
    return render(request,'termo.html', dados)
