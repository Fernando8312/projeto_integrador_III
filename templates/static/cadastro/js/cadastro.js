...
function add_animal(){
    ...
    //+"<div class='row'>"
    +"<div class='col-md-1'>Idade:<input type='text' id='idade_animal' class='form-control idade_animal' placeholder='' name='idade_animal' maxlength='30'></div>"
...
function add_animal_modal(){
    ...
    +"Idade:<input type='text' class='form-control idade_animal_modal' placeholder='' name='idade_animal_modal' value='' maxlength='30'></div>"
    +"<div class='form-group col-md-2'>"
...
function displayData(data) {
    ...
    for(i=0; i<data['dados'].length; i++){
        $('#dados_usuarios').append('<tr id="user-' + data['dados'][i]['id'] + '"><td class="userData" id="user-id-' + data['dados'][i]['id'] + '" name="user-id">' + data['dados'][i]['id'] + '</td>'
                                    ...
                                    +'<td><span><i class="fas fa-trash"></i></span><button class="btn btn-secondary w-100 py-1 bt-editar" data-toggle="modal" data-target="#exampleModal" onclick="editUser(' + data['dados'][i]['id'] + ')"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-pen" viewBox="0 0 16 16">'
                                    ...
                                    +'<a class="dropdown-item" href="/pre/'+ data['dados'][i]['id'] +'" target="_blank">Termo Pré-Operatório</a>'
                                    +'<a class="dropdown-item" href="/pos/'+ data['dados'][i]['id'] +'" target="_blank">Termo Pós-Operatório</a>'
                                    +'</div></div></td>'
                                    +'<td><button onclick="apagar_usuario('+ data['dados'][i]['id'] +')" class="btn btn-secondary w-100 py-1 bt-apagar"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-trash3" viewBox="0 0 16 16">'
        ...
        $.ajax({
            ...
            success: (data) => {
                ...
                for(i=0;i<data['animais'].length; i++){
                    ...
                    //+"<div class='row'>"
                    +"<div class='form-group col-md-1'>"
                    +"Idade:<input type='text' class='form-control idade_animal_modal' placeholder='' name='idade_animal_modal' value='"+ data['animais'][i]['fields']['idade_animal']+"' maxlength='30'></div>"
                    +"<div class='form-group col-md-2'>"
